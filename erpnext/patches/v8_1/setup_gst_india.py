...
<p>Please refer {gst_document_link} to know more about how to setup and implement GST in A24ERP.</p>

<p>Please contact us at support@ascent24.io, if you have any questions.</p>

<p>Thanks,</p>
A24ERP Team.
	""".format(gst_document_link="<a href='http://frappe.github.io/erpnext/user/manual/en/regional/india/'> A24ERP GST Document </a>")

	try:
		sendmail_to_system_managers("[Important] A24ERP GST updates", message)
