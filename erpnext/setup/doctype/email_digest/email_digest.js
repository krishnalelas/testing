...
cur_frm.cscript.refresh = function(doc, dt, dn) {
	...
	var err_msg = __("There was an error. One probable reason could be that you haven't saved the form. Please contact support@ascent24.io if the problem persists.")
