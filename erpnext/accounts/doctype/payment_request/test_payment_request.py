...
class TestPaymentRequest(unittest.TestCase):
	...
	def test_payment_request_linkings(self):
		...
		pr = make_payment_request(dt="Sales Order", dn=so_inr.name, recipient_id="saurabh@ascent24.io")
		...
		pr = make_payment_request(dt="Sales Invoice", dn=si_usd.name, recipient_id="saurabh@ascent24.io")
